          ...
          breadcrumb($args); ?>
            <!-- <div class="breadcrumb">
                <ul class="breadcrumb-list">
                  <li class="breadcrumb-list__item" itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="<?php echo home_url('/') ?>" itemprop="url"><span itemprop="title">COSトップ</span></a></li>
                  <li>&gt;</li>
